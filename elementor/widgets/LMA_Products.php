...
class LMA_Products extends Widget_Base
{
    ...
    {
        return ['lma-woocommerce', 'woocommerce-general'];
    }
    ...
    protected function add_style_controls()
    {
        ...
        $this->add_control('category_filter_alignment', [
            ...
            'default' => 'center',
            'selectors' => [
                '{{WRAPPER}} .cat_filter' => 'text-align: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_responsive_control('category_filter_spacing', [
            ...
            'selectors' => [
                '{{WRAPPER}} .cat_filter' => 'margin-bottom: {{SIZE}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_responsive_control('category_button_gap', [
            ...
            'selectors' => [
                '{{WRAPPER}} .ajax_post_cat' => 'margin: 0 {{SIZE}}{{UNIT}} {{SIZE}}{{UNIT}} 0;',
            ],
        ]);
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            ...
            'selector' => '{{WRAPPER}} .ajax_post_cat',
        ]);
        ...
        $this->add_control('category_text_color', [
            ...
            'default' => '#333333',
            'selectors' => [
                '{{WRAPPER}} .ajax_post_cat' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_control('category_bg_color', [
            ...
            'default' => '#f5f5f5',
            'selectors' => [
                '{{WRAPPER}} .ajax_post_cat' => 'background-color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_responsive_control('category_border_radius', [
            ...
            'selectors' => [
                '{{WRAPPER}} .ajax_post_cat' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_responsive_control('category_padding', [
            ...
            'selectors' => [
                '{{WRAPPER}} .ajax_post_cat' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_control('category_hover_text_color', [
            ...
            'default' => '#ffffff',
            'selectors' => [
                '{{WRAPPER}} .ajax_post_cat:hover' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_control('category_hover_bg_color', [
            ...
            'default' => '#666666',
            'selectors' => [
                '{{WRAPPER}} .ajax_post_cat:hover' => 'background-color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_group_control(Group_Control_Box_Shadow::get_type(), [
            ...
            'selector' => '{{WRAPPER}} .ajax_post_cat:hover',
        ]);
        ...
        $this->add_control('category_hover_transition', [
            ...
            'selectors' => [
                '{{WRAPPER}} .ajax_post_cat' => 'transition: all {{SIZE}}{{UNIT}} ease-in-out;',
            ],
        ]);
        ...
        $this->add_control('category_active_text_color', [
            ...
            'default' => '#ffffff',
            'selectors' => [
                '{{WRAPPER}} .ajax_post_cat.active' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_control('category_active_bg_color', [
            ...
            'default' => '#0073aa',
            'selectors' => [
                '{{WRAPPER}} .ajax_post_cat.active' => 'background-color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_group_control(Group_Control_Box_Shadow::get_type(), [
            'name' => 'category_active_box_shadow',
            'selector' => '{{WRAPPER}} .ajax_post_cat.active',
        ]);
        ...
        $this->add_control('category_active_transform', [
            ...
            'selectors' => [
                '{{WRAPPER}} .ajax_post_cat.active' => 'transform: scale({{SIZE}});',
            ],
        ]);
