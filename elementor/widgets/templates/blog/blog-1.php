...
<div class="apl_block_wraper lma_block_style_1">
    ...
    <div class="ajaxpost_loader <?php echo esc_attr($blog_columns) ?>" 
        data-block_style="<?php echo esc_attr($blog_layout) ?>" 
        data-column="<?php echo esc_attr($blog_columns) ?>" 
        data-post_type="post" 
        data-text_limit="<?php echo esc_attr($excerpt_limit) ?>" 
        data-title_limit="<?php echo esc_attr($title_limit) ?>" 
        data-order="6" 
