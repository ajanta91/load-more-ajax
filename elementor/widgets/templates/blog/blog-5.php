...
<div class="<?php echo esc_attr($wrapper_classes); ?>">
    <div class="ajaxpost_loader" data-block_style="<?php echo esc_attr($blog_layout) ?>" data-post_type="post" data-text_limit="<?php echo esc_attr($excerpt_limit) ?>" data-title_limit="<?php echo esc_attr($title_limit) ?>" data-order="1" data-limit="<?php echo esc_attr($per_page) ?>" data-cate="" data-slides_per_view="<?php echo esc_attr($slides_per_view) ?>" data-show_arrows="<?php echo $show_arrows === 'yes' ? 'true' : 'false'; ?>" data-show_dots="<?php echo $show_dots === 'yes' ? 'true' : 'false'; ?>" data-autoplay="<?php echo $show_autoplay === 'yes' ? 'true' : 'false'; ?>">
    </div>
</div>
