<?php if (!defined('ABSPATH'))
    exit; ?>
<div class="wrap">
    <h1 class="wp-heading-inline"><?php _e('Post Block Shortcode', 'load-more-ajax') ?></h1>
        ...
        <thead>
            <tr>
                ...
                <th scope="col" id="title" class="manage-column column-title column-primary sortable desc" abbr="Title">
                    <a href="http://localhost/blocky/wp-admin/edit.php?orderby=title&amp;order=asc"><span>Title</span><span
                ...
                <th scope="col" id="date" class="manage-column column-date sorted desc" aria-sort="descending"
                    abbr="Date"><a
                        href="http://localhost/blocky/wp-admin/edit.php?orderby=date&amp;order=asc"><span>Date</span><span
                            class="sorting-indicators"><span class="sorting-indicator asc"
                                aria-hidden="true"></span><span class="sorting-indicator desc"
                ...
                foreach ($all_blocks as $data) {
                    ...
                    <tr id="post-1"
                        ...
                        <td class="column-shortcode" data-colname="shortcode"><a href="javascript:void(0)"
                                ...
                                <?php echo $post_type . $taxonomy_attr . $block_style . $per_page . $filter . $include . $exclude . $text_limit . $cloumn ?>]</a>
                        </td>
        ...
        <tfoot>
            <tr>
                ...
                <th scope="col" class="manage-column column-title column-primary sortable desc" abbr="Title"><a
                        href="http://localhost/blocky/wp-admin/edit.php?orderby=title&amp;order=asc"><span>Title</span><span
                            class="sorting-indicators"><span class="sorting-indicator asc"
                                aria-hidden="true"></span><span class="sorting-indicator desc"
                                aria-hidden="true"></span></span> <span class="screen-reader-text">Sort
                            ascending.</span></a></th>
